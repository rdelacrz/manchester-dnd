...
use crate::freeform::{FreeformIntent, FreeformIntentState};
use crate::hero::HeroCreator;
use crate::images::SceneImagePanel;
use crate::info::{GuidePage, LegalPage, PrivacyAndSafetyPage};
use crate::lifecycle::CampaignLifecyclePanel;
...
fn authored_object_label(object_id: &str) -> &'static str {
    match object_id {
